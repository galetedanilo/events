...
public class EventControllerIT {
	...
	public void updateShouldUpdateResourceWhenIdExists() throws Exception {
		...
		EventDTO dto = new EventDTO(null, "Expo XP", LocalDate.of(2021, 8, 18), "https://expoxp.com.br", 1L);
		...
		result.andExpect(jsonPath("$.date").value("2021-08-18"));
	...
	public void updateShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		...
		EventDTO dto = new EventDTO(null, "Expo XP", LocalDate.of(2021, 8, 18), "https://expoxp.com.br", 7L);
		String jsonBody = objectMapper.writeValueAsString(dto);
